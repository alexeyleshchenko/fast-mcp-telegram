"""Tests for parse_telegram_url helper in src.utils.entity.
...
def test_tme_username() -> None:
    assert parse_telegram_url("https://t.me/durov") == "durov"
...
def test_tme_username_with_message_id() -> None:
    assert parse_telegram_url("https://t.me/durov/12345") == "durov"


def test_tme_username_deep_link() -> None:
    assert parse_telegram_url("https://t.me/durov/12345?single") == "durov"


def test_tme_no_scheme() -> None:
    assert parse_telegram_url("t.me/durov") == "durov"


def test_tme_http() -> None:
    assert parse_telegram_url("http://t.me/durov") == "durov"


def test_tme_www_prefix() -> None:
    assert parse_telegram_url("https://www.t.me/durov") == "durov"


def test_tme_channel_numeric_c() -> None:
    """https://t.me/c/1234567890 → Telethon channel ID -1001234567890."""
    assert parse_telegram_url("https://t.me/c/1234567890") == "-1001234567890"
...
def test_tme_channel_numeric_c_with_message() -> None:
    assert parse_telegram_url("https://t.me/c/1234567890/999") == "-1001234567890"
...
def test_tme_invite_link() -> None:
    ...
    assert parse_telegram_url(url) == url
...
def test_tme_stories() -> None:
    ...
    assert parse_telegram_url("https://t.me/s/durov") == "durov"


def test_tme_boost() -> None:
    """https://t.me/boost/username → username."""
    assert parse_telegram_url("https://t.me/boost/durov") == "durov"
...
def test_telegram_me_username() -> None:
    assert parse_telegram_url("https://telegram.me/durov") == "durov"


def test_telegram_me_no_scheme() -> None:
    assert parse_telegram_url("telegram.me/durov") == "durov"


def test_telegram_me_www() -> None:
    assert parse_telegram_url("https://www.telegram.me/durov") == "durov"
...
def test_telegram_dog_username() -> None:
    ...
    assert parse_telegram_url("https://telegram.dog/durov") == "durov"
...
def test_non_telegram_url() -> None:
    assert parse_telegram_url("https://example.com/durov") is None


def test_non_telegram_url_with_path() -> None:
    assert parse_telegram_url("https://example.com/t.me/durov") is None


def test_plain_username() -> None:
    """Regular @username or bare username should NOT match."""
    assert parse_telegram_url("durov") is None
...
def test_numeric_string() -> None:
    assert parse_telegram_url("123456789") is None
...
def test_just_domain_no_path() -> None:
    ...
    assert parse_telegram_url("https://t.me") is None


def test_me_identifier() -> None:
    """Special 'me' identifier should not be altered."""
    assert parse_telegram_url("me") is None


def test_self_identifier() -> None:
    assert parse_telegram_url("self") is None
...
def test_tg_resolve_domain() -> None:
    ...
    assert parse_telegram_url("tg://resolve?domain=durov") == "durov"
...
def test_tg_user_id() -> None:
    ...
    assert parse_telegram_url("tg://user?id=123456789") == "123456789"
...
def test_username_with_dots() -> None:
    assert parse_telegram_url("https://t.me/user.name") == "user.name"


def test_username_with_underscores() -> None:
    assert parse_telegram_url("https://t.me/user_name") == "user_name"
