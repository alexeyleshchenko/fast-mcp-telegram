### 2026-07-28
- **v0.44.0 released:** Rich message send/edit via `parse_mode="rich"`. GitHub release `0.44.0`; manual deploy via `deploy.sh`; PyPI via hermes `twine` (GH Actions disabled); container healthy; EN+RU Telegram posts.
